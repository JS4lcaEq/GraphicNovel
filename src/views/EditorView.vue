        ...
        <el-row>
            <el-col :span="10">
                <div>
                    ...
                    <p>
                        <el-button type="success" @click="onAdd">{{ $t('message.editor.addScene') }}</el-button>
                    </p>
                    <el-card v-if="store.selectedNode" class="edit-form">
                        <template #header>
                            <div class="card-header">
                                <span>{{ $t('message.editor.title') }}</span>
                        ...
                        <el-form :model="form" :rules="formRules" label-width="auto" class="scene-form">
                            ...
                            <el-form-item :label="$t('message.editor.text')" prop="text">
                                <el-input v-model="form.text" type="textarea" :rows="4" />
                            </el-form-item>

                            <el-form-item :label="$t('message.editor.bg')" prop="bg">
                                <el-col :span="11">
                            ...
                            <el-form-item :label="$t('message.editor.style')" prop="className">
                                <el-col :span="11">
                            ...
                            <el-form-item label="." prop="buttons">
                                <el-button type="primary" @click="saveChanges">{{ $t('message.editor.save') }}</el-button>
                                <span v-if="!store.isExistsInputButtonGo(form.id)">
                                    &nbsp; <el-button type="danger" @click="onDel">{{ $t('message.editor.delScene')  }}</el-button>
                                </span>

                            </el-form-item>

                            <el-form-item :label="$t('message.editor.buttons.title')">
                                <div>{{ $t('message.editor.buttons.subject') }}</div>
                                        ...
                                        <el-popconfirm title="Are you sure to delete this button?"
                                            ...
                                            <template #reference>
                                                <el-button type="danger">
                                                    {{ $t('message.editor.buttons.del') }}
                                                </el-button>
                                            </template>
                                        </el-popconfirm>
                                    </div>
                                    <el-button type="primary" @click="onAddButton">
                                        {{ $t('message.editor.buttons.add') }}
                                    </el-button>
                                </el-space>
                            </el-form-item>
