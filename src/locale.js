...
<ol>
      ...
      <li>Заменить содержимое файла data.js своими данными которые можно получить в разделе Файлы
          <ul>
              <li>стереть все между квадратными скобками "const data = [...]"</li>
              <li>вставить свои данные из файла скаченного в разделе Файлы между квадратными скобками</li>
              <li>сохранить измененный файл data.js</li>
          </ul>
      </li>
      <li>Поместить все изображения в папку img рядом с run.html</li>
      <li>Открыть run.html в браузере</li>
</ol>
    `,
        },
        files: {
